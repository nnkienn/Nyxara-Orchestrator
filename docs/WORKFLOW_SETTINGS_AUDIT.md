...
| Executor | `executorLimits.maxToolCallsPerTask` (`25`), `maxModelTurnsPerTask` (`8`), `maxToolResultBytes` (`65536`); model/tool safety and resource limits, not new Workflow controls. |
