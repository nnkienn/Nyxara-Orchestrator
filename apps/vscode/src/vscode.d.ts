declare module "vscode" {
  ...
  export interface ExtensionContext { readonly extensionMode?: number; subscriptions: { push(...items: any[]): void }; secrets: { get(key: string): Promise<string | undefined>; store(key: string, value: string): Promise<void>; delete(key: string): Promise<void> }; extension?: { packageJSON?: { version?: string } }; extensionUri: Uri; globalStorageUri?: Uri; }
